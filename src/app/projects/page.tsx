...
export default function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "LDAP User Authentication Application",
      description: "Aplikacja web do uwierzytelniania użytkowników zbudowana w Laravel. Projekt szkolny z pełną odpowiedzialnością za implementację integracji LDAP, logiki uwierzytelniania i interfejsu użytkownika.",
      image: "/api/placeholder/600/400",
      technologies: ["Laravel", "PHP", "LDAP", "MySQL", "HTML", "CSS"],
      category: "fullstack",
      githubUrl: "https://github.com/MikolajKarla",
      liveUrl: "#",
      featured: true,
      year: "2024"
    },
    {
      id: 2,
      title: "Data Analyzing App",
      description: "Aplikacja do wizualizacji i normalizacji danych z interfejsem użytkownika w Next.js i backendem FastAPI w Python. Wykorzystuje biblioteki analizy danych jak Pandas i NumPy.",
      image: "/api/placeholder/600/400",
      technologies: ["Next.js", "FastAPI", "Python", "Pandas", "NumPy", "TypeScript"],
      category: "fullstack",
      githubUrl: "https://github.com/MikolajKarla/data-visualize.git",
      liveUrl: "#",
      featured: true,
      year: "2024"
    },
    {
      ...
      description: "Projektowanie i rozwijanie niestandardowych stron WordPress dla różnych klientów w ramach freelance. Zarządzanie pełnym cyklem życia projektów.",
      image: "/api/placeholder/600/400",
    ...
    {
      id: 4,
      title: "IT Projects Portfolio",
      description: "Różnorodne projekty IT realizowane w zespole podczas praktyk w Record Sp. z o.o., demonstrując zaangażowanie i chęć nauki nowych rozwiązań.",
      image: "/api/placeholder/600/400",
      technologies: ["Various", "Team Collaboration", "Problem Solving"],
      category: "fullstack",
      githubUrl: "https://github.com/MikolajKarla",
      liveUrl: "#",
      featured: false,
    ...
    {
      id: 5,
      title: "Math and IT Tutoring System",
      description: "System korepetycji z matematyki i informatyki, budowanie pozytywnych relacji z uczniami i ich rodzicami, przekładanie złożonych zagadnień na przystępny język.",
      image: "/api/placeholder/600/400",
      technologies: ["Educational Methods", "Communication", "Problem Solving"],
      category: "education",
      githubUrl: "#",
      liveUrl: "#",
      featured: false,
