...
const translations = {
  pl: {
    ...
    'home.faq.body': 'To normalne. Zebraliśmy i wyczerpująco odpowiedzieliśmy na pytania, które pojawiają się przed nową inwestycją cyfrową. Nasza współpraca opiera się na pełnej transparentności.',
